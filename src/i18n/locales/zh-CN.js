export default {
  ...
  themeConfigPage: {
    sectionTitle: '主题配置',
    sectionDescription: '配置前端主题、背景、自定义样式等。',
    saveButton: '保存配置',
    fields: {
      theme: '前端主题',
      themePlaceholder: '主题名称（留空使用默认）',
      bgUrl: '背景图片 URL',
      adminPath: '管理员面板路径',
      customHtml: '自定义 HTML',
      customHtmlPlaceholder: '插入到页面中的自定义 HTML',
      customCss: '自定义 CSS',
      customCssPlaceholder: '自定义 CSS 样式',
    },
    messages: {
      loadFailed: '加载主题配置失败',
      saveSuccess: '主题配置已保存',
  ...
  nodeGroupsPage: {
    sectionTitle: '权限组管理',
    sectionDescription: '管理节点权限组：用于把多组节点绑定到不同套餐。',
    addButton: '添加权限组',
    editTitle: '编辑权限组',
    createTitle: '新建权限组',
    fields: {
    ...
    messages: {
      ...
      deleteFailed: '删除失败',
      saveFailed: '保存失败',
      deleteConfirm: '确定要删除权限组「{name}」吗？',
      deleteConfirmTitle: '删除权限组',
    },
  },
  nodeRoutesPage: {
    sectionTitle: '路由管理',
    sectionDescription: '配置节点出站路由策略。',
    addButton: '添加路由',
    editTitle: '编辑路由',
    createTitle: '新建路由',
    fields: {
      remarks: '备注',
      remarksRequired: '请输入备注',
      match: '匹配规则',
      action: '处理动作',
      actionValue: '动作参数',
    },
    ...
    messages: {
      ...
      deleteFailed: '删除失败',
      saveFailed: '保存失败',
      invalidJson: '动作参数不是合法 JSON',
      deleteConfirm: '确定要删除路由「{name}」吗？',
      deleteConfirmTitle: '删除路由',
    },
  },
  nav: {
    overview: '总览',
  ...
  notices: {
    ...
    messages: {
      ...
      editSuccess: '公告已保存',
      deletePending: '确定要删除公告「{title}」吗？该操作不可恢复。',
