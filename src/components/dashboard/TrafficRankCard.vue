...
<template>
  <el-card v-loading="loading" class="section-card traffic-rank-card" shadow="never">
      ...
      >
        ...
        <div class="traffic-rank-data">
          <div class="traffic-rank-values">
            ...
            <span class="traffic-rank-change" :class="changeClass(item.change)">
              {{ item.changeText }}
            </span>
          </div>
          ...
          <div class="traffic-rank-bar">
            <span
              ...
              :style="{ width: progressWidth(item.value, rankData.list[0]?.value || 0) }"
            ></span>
          </div>
        </div>
      </div>
